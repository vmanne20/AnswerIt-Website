...
<div name="home" id="header">
 ...
 <!-- <?php
  $firstNameErr = $lastNameErr = $emailErr = $pwdErr = $confirmPwdErr = $userTypeErr = "";
  $firstName = $lastName = $email = $pwd = $confirmPwd = $userType = "";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
    ...
    if (empty($_POST["password"]))
    {
     ...
     if (empty($_POST["checkpwd"]))
    {
     $confirmPwdErr = "You have to confirm password";
    } 
...
<div class="background" id="background"> 
  <aside>
    <div name="sl" class="left">
      ...
      <form role="form" action="addCustomer.php" action="askhome.php" method="post">
      ...
      <div class="form-group">
        <label for="pwd">Phone Number (Optional):</label>
      ...
      <input type="radio" name="usertype" value="1"> Asker
      <input type="radio" name="usertype" value="2"> Tutor
      <br><br>
