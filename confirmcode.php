...
<html>
<head>
<title>AnswerIt - Confirmation Code</title>
...
<h1> Confirm that it is you. </h1>
<p> <span style="color:red">We sent you a confirmation e-mail to ensure that you are trying to reset the password and no one else. <br>
Enter the confirmation code in the email in the textbox below.</span> </p>
<form role="form" action="resetpass.php" method="get">
<div class="form-group">
      <label for="pwd">Confirmation Code:</label>
      <input type="password" class="form-control" id="pwd" placeholder="Enter confirmation code" name="code">
    </div>
