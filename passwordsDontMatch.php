...
<div class="background" id="background"> 
  <aside>
    <div name="sl" class="left">
      ...
      <div class="form-group">
        <label for="pwd">Password:</label> <span style="color:red; text-align:left"> * Passwords don't match. </span>
        <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="password">
      </div>
      <div class="form-group">
        <label for="pwd">Confirm Password:</label> <span style="color:red; text-align:left">  * </span>
        <input type="password" class="form-control" id="checkpwd" placeholder="Re-enter password" name="checkpwd">
      </div>
      <input type="radio" name="customer" value="asker"> Asker
      <input type="radio" name="customer" value="answerer"> Tutor
      <br><br>
...
<aside>
  <div class = "right">
    ...
    <h1>
      ...
      <form role="form" action="answerhome.php" method="get">
        <div class="form-group">
